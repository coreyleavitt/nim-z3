# nim-z3 v0.3 plan (archived)

> **Archived 2026-05-30 after the v0.3.0 tag.** This is the *historical*
> plan that drove v0.3; the live plan for ongoing work is
> [IMPLEMENTATION_PLAN.md](IMPLEMENTATION_PLAN.md). Read this file when
> you need design rationale for the v0.3 architectural unification,
> the `z3/semantics` relocation, the Char/String/Seq/Regex/FP/FuncDecl
> theory families, the solver-tactic bridges, the sortdispatch
> consolidation, or the v0.3-era §8 deferral ledger (including the §8b
> "Pre-tag audit" block); don't update it.

A type-safe, memory-safe, idiomatic Nim wrapper for the Z3 SMT solver.

**Status as of archiving**: shipped. v0.2 shipped 2026-05-29; v0.3 followed 2026-05-30. Each step of the implementation sequence (§5) closed with a §8 deferral entry; the §8b "Pre-tag audit" block catalogues which v0.3-promised items did and didn't land before the tag.
