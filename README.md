...
- [`docs/V0.6_PLAN.md`](docs/V0.6_PLAN.md) — the archived v0.6 = v1.0.0 plan. Originally framed as a version-only delta from v0.5.0; what actually shipped also incorporated the five-round v1.0-readiness audit cycle (~95 substantive items, 1 latent CRITICAL resolved, 14 HIGH closed). See CHANGELOG `[1.0.0]` for the full record.
- [`docs/IMPLEMENTATION_PLAN.md`](docs/IMPLEMENTATION_PLAN.md) — the **live** plan, currently the v1.x post-1.0 roadmap. Documents the three deferred-to-v1.x additive features (`Z3Set[E]`, model-decl enumeration, `seq_replace_all`) and the SemVer decision rules.
