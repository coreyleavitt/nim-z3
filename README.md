...
- [`docs/IMPLEMENTATION_PLAN.md`](docs/IMPLEMENTATION_PLAN.md) — the **live** plan, currently the v0.5 1.0-readiness polish (promoted from its v0.3-era draft after v0.4.0 shipped). Cross-family parity, naming + cohesion hygiene, error type hierarchy, examples, docs + GOTCHAS, property-test extension, feature flags.

## Versioning

Pre-1.0 the public surface may shift between minor versions. We track deferrals and design changes in the live `docs/IMPLEMENTATION_PLAN.md` (and the archived `V0.1_PLAN.md` §18 / `V0.2_PLAN.md` §8 / `V0.3_PLAN.md` §8 + §8b / `V0.4_PLAN.md` §8 + §8b for prior-version deferrals); consult `CHANGELOG.md` for the per-release diff.
